...
#+SUBTITLE: for version 2.0.1 (v2.0.1-35-g7a56987+1)
...
#+TEXINFO: @noindent
This manual is for Ghub version 2.0.1 (v2.0.1-35-g7a56987+1).
...
- Where one would use ~user/repo~ when accessing Github, one has to
  use ~user%2Frepo~ when accessing Gitlab, e.g.:
